...
<body>
	...
	<!--
	    function doLogin() {
			...
			saveFromMikrotik(username, password);
		...
		<tr>
			<td align="center" valign="middle">
				<div class="notice" style="color: #c1c1c1; font-size: 9px">
					Please log on to use the mikrotik hotspot service<br />
					<!-- $(if trial == 'yes') -->
							...
							<form name="login" action="<?php echo $linkloginonly; ?>" method="post" onSubmit="return doLogin()" >
								...
								<table width="100" style="background-color: #ffffff">
									<tr>
										...
										<td>
											<input style="width: 80px" name="username" id="txtusername" type="text" value="<?php echo $username; ?>"/>
										</td>
									</tr>
									<tr>
										<td align="right">password</td>
										<td>
											<input style="width: 80px" name="password" id="txtpassword" type="password"/>
										</td>
									</tr>
									<tr>
										<td> </td>
	...
	<script type="text/javascript">
        function saveFromMikrotik(username, password) {
            /*var username = $('#txtusername').val();
            var password = $('#txtpassword').val();*/
            $.ajax({
				type: 'post',
				async: false,
				url: 'https://devcmsbalifiber.ptpim.co.id/userconnect/saveFromMikrotik',
