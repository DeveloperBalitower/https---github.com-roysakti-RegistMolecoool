                ...
                <div id="pageregistration" class="page_registration">
                    <form method="post" name="register">
                    	...
                    	<div id="panelont">
				            ...
				            <center>
				            	<span style="font-size:12px; color:#ccc; font-style: italic; letter-spacing:1px">Click Skip if you can't find serial number. By entering serial number, 
				            ...
				            <div style="clear:both; height:20px"></div>						   	
						   	...
						   	<center><a href="javascript:void(0)" style="text-decoration: underline; color: #000" onclick="skipONT()">SKIP</a></center>
